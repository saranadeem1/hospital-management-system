...
def insertion():
    try:
        ...
        mobile_no=int(input("enter mobile no of doctors"))
        ...
        cur.execute("insert into doctors(name,id,age,date_of_birth,mobile_no,specialization,fees,years_of_experience)values('%s',%d,%d,'%s','%d','%s',%d,%d)"%(name,id,age,date_of_birth,mobile_no,specialization,fees,years_of_experience))
        print()
...
def updation():
    try:
        ...
        fees=int(input("enter fees of doctors"))
        years_of_experience=int(input("enter years of experience"))
        cur.execute("update doctors set name='%s',age=%d, date_of_birth='%s', mobile_no='%s', specialization='%s', fees=%d,years_of_experience=%d where id= %d"%(name,age,date_of_birth,mobile_no,specialization,fees,years_of_experience,id))
        print()
        con.commit()
...
def insertion1():
    try:
        ...
        contact_no=int(input("enter contact no of patients"))
...
def updation1():
    try:
        ...
        department=input("enter department of patients")
        consultancy_fees=int(input("enter consultancy fees of patients"))
        cur.execute("update patients set name='%s',age=%d ,gender='%s',address='%s',contact_no='%s',date_of_birth='%s',consultant_name='%s',date_of_consultancy='%s',department='%s',consultancy_fees=%d where patient_ID= %d"%(name,age,gender,address,contact_no,date_of_birth,consultant_name,date_of_consultancy,department,consultancy_fees,patient_ID))
        print()
        con.commit()
        print("data updated successfully")
    except sq.Error as er:
...
def updation2():
    try:
        ...
        cur.execute("update Room_Info set room_type='%s',room_charges_per_day=%d,room_status='%s',patient_name='%s'where room_no= %d"%(room_type, room_charges_per_day, room_status, patient_name, room_no))
        print()
        con.commit()
        print("data updated successfully")
    except sq.Error as er:
...
def updation3():
    try:
        ...
        doctor_fees=int(input("enter doctor fees"))    
        total_amount=int(input("enter total amount of bill"))
        cur.execute("update bill_details set bill_date='%s', name='%s', room_type='%s', room_charges=%d, pathology_fees=%d, doctor_fees=%d, total_amount=%d where bill_no= %d"%(bill_date, name, room_type, room_charges, pathology_fees, doctor_fees, total_amount,bill_no))
        print()
        con.commit()
        print("data updated successfully")
    except sq.Error as er:
